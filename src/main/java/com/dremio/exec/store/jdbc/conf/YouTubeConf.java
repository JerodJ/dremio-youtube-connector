...
@SourceType(value = "YouTubeARP", label = "YouTube",uiConfig = "youtube-layout.json")
public class YouTubeConf extends AbstractArpConf<YouTubeConf> {
  private static final String ARP_FILENAME = "arp/implementation/youtube-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.youtube.YouTubeDriver";
